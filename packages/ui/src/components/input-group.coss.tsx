...
import { Textarea, type TextareaProps } from "./textarea.coss";

function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: <fieldset> is not a semantic element in this case
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: Interactivity is needed to focus the nested input or textarea
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Interactivity is needed to focus the nested input or textarea
    <div
