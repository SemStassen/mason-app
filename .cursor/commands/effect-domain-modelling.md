 ...
 * }
 */
export const isPending = (self: Task): self is Pending =>
  self._tag === "pending";
...
declare namespace Schedulable$ {
  function make<A>(get: (self: A) => any, set: (self: A, date: any) => A): any;
 ...
 * @since 0.1.0
 */
export const isCustomer = (self: User): self is Customer =>
  self._tag === "Customer";
